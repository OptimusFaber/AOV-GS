"""
ActiveOpenSem (office0) — direct port of ActiveSGM's
``ActiveSemNoOneFormer.py``: a SplaTAM backbone driven by the geometric
...
downstream language-field training.
"""
...
sam_clip = dict(
    ...
    # Where to run SAM+CLIP. Default cuda:0 (single GPU).
    # Two GPUs: set GPU=0,1 and device="cuda:1", or pass --seg_device cuda:1 / SEM_DEVICE=cuda:1.
    device = "cuda:0",
