...
if slam["method"] == "semsplatam":
    slam.update(
        ...
        # To avoid HF outages (503), you can pre-download the processor/model and point to a local folder:
        #   export ONEFORMER_ADE20K_CKPT=/abs/path/to/oneformer_ade20k_swin_large
        ade20k_checkpoint=os.environ.get(
            "ONEFORMER_ADE20K_CKPT",
