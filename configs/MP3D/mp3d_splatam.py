...
config = dict(
    ...
    mapping=dict(
        ...
        add_new_gaussians=False,  # MP3D: silhouette densify can crash sparse semantic backward
        ...
        prune_gaussians=False, # MP3D: pruning + sparse semantic backward unstable on Habitat
